...
//                   setSelectedCategory("All");
//                 }}
//                 className="px-6 py-3 bg-sonarb-navy text-white rounded-xl font-semibold shadow hover:bg-sonarb-navy-light transition duration-300"
//               >
//                 View All Courses
//               </button>
//             </div>
...
//             Our career counselors can help you choose the perfect learning path
//             based on your goals and experience.
//           </p>
//           <div className="flex flex-col sm:flex-row gap-4 justify-center">
//             <button className="px-6 py-3 bg-white text-gray-900 border border-gray-900 rounded-xl font-semibold shadow hover:bg-sonarb-navy-light transition duration-300">
//               Schedule Free Consultation
//             </button>
//             <button className="px-6 py-3 border border-sonarb-navy bg-gray-900 text-sonarb-navy rounded-xl font-semibold shadow hover:bg-gray-600 hover:text-white transition duration-300">
//               Take Our Quiz
//             </button>
//           </div>
//         </div>
    ...
    <div>
      ...
      <section className="py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <button className="px-6 py-3 bg-white text-gray-900 border border-gray-900 rounded-xl font-semibold shadow hover:bg-gray-100 transition duration-300">
              Schedule Free Consultation
            </button>
            <button className="px-6 py-3 border border-gray-900 bg-gray-900 text-white rounded-xl font-semibold shadow hover:bg-gray-700 transition duration-300">
              Take Our Quiz
            </button>
          </div>
        </div>
